...
export const Waitlist4Variety = () => {
  ...
  return (
    <div className="bg-[url('/assets/images/svgs/bg-2.svg')] flex flex-col justify-start pt-[100px] items-center w-full h-[1100px] mt-[90px] bg-cover">
      <JoinWaitListHeader />
      <div className="w-[70%]">
        <div className="text-[#000] font-pangram-medium text-[54px] text-center leading-[60px] pt-[20px]">
          ...
          <span className="bg-[#D87023] text-[#fff] pr-[20px] pl-[10px] border-4 border-[#000] rounded-[50px]">
            Foodie&rsquo;s Paradise
          </span>
          : Find Your Next Meal here on chow.
        </div>
